...
public class GetMovieApiData extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MainActivity.recievedData = data;
        MainActivity.waitDataResponse.setText(" ");
        if(data.isEmpty()){
            Log.i("madara ", " No data lol");
        }else {
            Log.i("madara ", data );
        }
    }
